<?php include("./././controller/backend/read_comments.php"); ?>
            ...
            <div class="col-md-12 mt20">
                  <table class=" col-md-12 table table-bordered table-striped table-hover tablepers">
                        ...
                        <tr class="row m0">
                              ...
                              <td class="col-2"><a href="index.php?action=updateUser&id=<?php echo $data['id_user']?>&filtre=4"><?php echo $data['firstName'].' '.$data['lastName'];?></td>
                        </tr>
                        <?php
                        }
                        ?>
