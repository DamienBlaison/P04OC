<?php include("./././controller/backend/updateUser.php") ?>
                  ...
                  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                        <div class="container-fluid">
                              <div class="row justify-content-around">
                                    <form action="index.php?action=updateUser&id=<?php echo $_GET['id']?>&filtre=4"class="container-fluid row justify-content-around" method="post">
                                          <div class="card-body col-md-5 coordonnees">
                                                <div class="row container-fluid">
                                                      <div class="row">
                                                            <label class="col-md-3" for="validationDefault01">Nom</label>
                                                            <input class="col-md-9" name="nom"type="text" class="form-control" id="validationDefault01" placeholder="Nom de famille" value="<?php echo $resultUser[2]?>">
                                                            <label class="col-md-3" for="validationDefault02">Prénom</label>
                                                            <input class="col-md-9" name="prenom" type="text" class="form-control" id="validationDefault02" placeholder="Prénom" value="<?php echo $resultUser[1]?>">
                                                            <label class="col-md-3" for="validationDefault03">email</label>
                                                            <input class="col-md-9" name="email" type="text" class="form-control" id="validationDefault03" placeholder="email" value="<?php echo $resultUser[3]?>">
                                                      </div>
                                                </div>
                                          </div>
                                          <div class="card-body col-md-5 coordonnees">
                                                <div class="row container-fluid">
                                                      <div class=" row">
                                                            ...
                                                            <input class="col-md-9" name="login" type="text" class="form-control" id="validationDefault04" placeholder="login" value="<?php echo $resultUser[4]?>">
                                                            <label class="col-md-3" for="validationDefault05">password</label>
                                                            <input class="col-md-9" name="password" type="text" class="form-control" id="validationDefault05" placeholder="password" value="<?php echo $resultUser[5]?>">
                                                            <label class="col-md-3" for="validationDefault06">role</label>
                                                            <input class="col-md-9" name="role"type="text" class="form-control" id="validationDefault06" placeholder="role" value="<?php echo $resultUser[6]?>">
                                                      </div>
                                                </div>
                                          </div>
                                    </div>
